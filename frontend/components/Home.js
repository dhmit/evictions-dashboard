    ...
    setStateTotals = (totals) => {
        let newState = {
            stats: {
                ...
                asian_renters: totals.demography.asian_renters.toLocaleString(),
                black_renters: totals.demography.black_renters.toLocaleString(),
                latinx_renters: totals.demography.latinx_renters.toLocaleString(),
                white_renters: totals.demography.white_renters.toLocaleString(),
                under18_pop: totals.demography.under18_pop.toLocaleString(),
            },
            tract: [],
            town: "Total",
        }
